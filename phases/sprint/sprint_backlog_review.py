...
If the sprint goals and sprint backlog are perfect and you have no comment on them, return only one line like "<INFO> Finished".
"""
...
class SprintBacklogReview(BasePhaseRepositoryImpl):
    def __init__(
        self,
        model_config,
